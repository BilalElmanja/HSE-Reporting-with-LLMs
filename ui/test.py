...
class LLM_model(LLM):
    ...
    def predict(self, prompt):
        os.environ["REPLICATE_API_TOKEN"] = "r8_Wy3th3wc1oX5iD5cGaQZiMXxkHMqjCz3AL1uU"
...
async def on_message( message: cl.Message):
    ...
    if chain.done and conversation_chain.done:
        ...
        model_response = await cl.make_async(prompt_template.create_response)(user_input, response_doc[0].page_content, current_conversation, chain.model)
        msg.content += "\n \n"
        await msg.update()
